...
//         var fbHelper, objTest, arrTest, scope, varName, recId, $q, newData, userData, newObj, path, baseBuilder, error, mockObj, obj, deferred, ref, $rootScope;
//         var FIXTURE_DATA = {
//             aString: 'alpha',
//             aNumber: 1,
//             aBoolean: false,
...
//             recId = 123;
//             path = ["users", recId];
//             inject(function(_mockObj_, _$q_, _fbHelper_, _baseBuilder_, _$rootScope_) {
