(function() {
    ...
    describe("Auth Manager", function() {
        var credentials, authTest, deferred, $q, auth, authMngr, afEntity, ref, $rootScope, mockAuth;

        beforeEach(function() {
            module('fireStarter.services');
            module("fbMocks");
            inject(function(_authMngr_, _$rootScope_, _$q_, _afEntity_, _mockAuth_) {
                $q = _$q_;
                afEntity = _afEntity_;
